...
<body>
	...
	<div style="width: 80%;margin-left: 10%;">
		...
		<ul id="top_right" class="collapse navbar-collapse nav navbar-nav navbar-right"	style="margin-right: 20px;">
			<li>
				<a href="#">
					<span class="badge"	style="background-color: red;">${user.bname}</span>
				</a>
			</li>
			<li>
				<a href="login.jsp">
		...
		<div class="page_main">
			<script type="text/javascript">
				...
				$("#showGoodsType").click(function(){
					$(".dv_content").attr("src","${pageContext.request.contextPath}/showGoodsType.html");
				})
				$("#addGoodsType").click(function(){
					$(".dv_content").attr("src","${pageContext.request.contextPath}/addGoodsType.html");
				})
